...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700" role="contentinfo" aria-label="Site footer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-md mb-6">
                A passionate researcher and developer focused on creating innovative solutions 
                and sharing knowledge through publications and open-source contributions.
              </p>
            ...
            <nav aria-labelledby="footer-navigation-heading">
              <h3 id="footer-navigation-heading" className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider mb-4">
                Navigation
              </h3>
            ...
            <nav aria-labelledby="footer-quicklinks-heading">
              <h3 id="footer-quicklinks-heading" className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider mb-4">
                Quick Links
              </h3>
              <ul className="space-y-3" role="list">
                <li>
