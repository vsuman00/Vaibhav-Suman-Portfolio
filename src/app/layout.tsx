...
export default function RootLayout({
  ...
  const websiteStructuredData = generateStructuredData('website', {
    ...
    description: 'Professional portfolio showcasing full stack development projects, blog posts, and technical expertise.',
    url: 'https://johndoe.dev',
    authorName: 'John Doe'
  })
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="/android-chrome-192x192.svg" />
